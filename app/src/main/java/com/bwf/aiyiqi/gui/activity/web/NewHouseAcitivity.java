...
public class NewHouseAcitivity extends BaseActivity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        icluceTextActivity.setText("新房装修");
    ...
    protected void initView() {
        ...
        newhouseWebview.loadUrl(Apis.FITMENT_NEWHOSE);
