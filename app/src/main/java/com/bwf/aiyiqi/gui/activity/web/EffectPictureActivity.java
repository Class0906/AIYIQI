...
import com.bwf.aiyiqi.gui.adpter.MyEffectPictureAdapter;
...
public class EffectPictureActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected int getContentViewResId() {
        return R.layout.effect_picture_activity;
    }
    ...
    protected void initView() {
        ...
        //绑定适配器
        MyEffectPictureAdapter effectPictureAdapter = new MyEffectPictureAdapter(getSupportFragmentManager(), designDischargeRoomActivityTablayout.getTabCount());
        designDischargeRoomActivityViewpager.setAdapter(effectPictureAdapter);
        //开启监听实现滑动一体
